...
image:https://travis-ci.com/pwr-piisw/angular-wyklad.svg?branch-master["Build Status", link="https://travis-ci.com/pwr-piisw/angular-wyklad"]
...
Client application can be launched by running following commands:
....
cd src/main/client
run start
....
